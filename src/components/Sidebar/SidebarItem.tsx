...
>(({ children, title, description, className, active, ...props }, ref) => {
  ...
  return (
    <Button
      className={cn(
        'flex shadow-none items-center transition-colors duration-500 bg-transparent w-12 h-12 xl:w-full xl:h-auto p-3 m-0 xl:py-2 xl:px-3 rounded-lg xl:justify-start gap-4 font-semibold [&_svg]:size-full xl:[&_svg]:size-4 [&_svg]:stroke-[1.3]',
